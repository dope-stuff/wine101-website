...
export default function ServiceDetail({elements, data}: ServiceDetailProps) {
  ...
  return (
    <div className="w-full flex-row flex-wrap lg:flex-nowrap justify-center flex gap-8 relative min-h-[300px] z-0">
      ...
      <div className="flex-1 max-w-[600px] min-w-[35%] flex-col flex justify-center gap-8 relative z-10">
        ...
        <>
          <SplashColorIcon className="max-w-none right-0 bottom-[-5rem] lg:right-0 lg:bottom-[-5rem] xl:bottom-[-2.8rem] absolute -z-10" />
          <div className="flex-col flex items-center gap-2 right-[5.5rem] bottom-[-2.5rem] lg:right-[5.5rem] lg:bottom-[-2.2rem] xl:bottom-0 absolute -z-10 text-[12px]">
            {data.subdetails &&
